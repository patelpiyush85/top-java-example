...
public class Services {
	...
	public static void sendMail(String emailid,int otp){
		final String username  = "patelnilpa847@gmail.com";//Sender Email
		final String password   = "uuebrquymzgachhv";//Sender Password
	...
	public static void sendMail1(String emailid,String pass){
		final String username  = "patelnilpa847@gmail.com";
		final String password   = "Nilpa@1988";
