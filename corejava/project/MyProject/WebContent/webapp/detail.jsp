					...
					<div class="carousel-inner bg-light">
						<div class="carousel-item active">
							<img class="w-100 h-100"
								src="product_imagest/<%=p.getProduct_image()%>" alt="Image">
						</div>
						<div class="carousel-item">
							<img class="w-100 h-100"
								src="product_images/<%=p.getProduct_image()%>" alt="Image">
						</div>
						<div class="carousel-item">
							<img class="w-100 h-100"
								src="product_images/<%=p.getProduct_image()%>" alt="Image">
						...
						%>
						   <%
						      boolean flag1=CartDao.checkcart(u.getUid(),p.getPid());
						       ...
						       {
						   %>
						   <a href="add-to-cart.jsp?pid=<%=p.getPid()%>"><button class="btn btn-primary px-3">
						   ...
						   <%
						       ...
						       {
						   %>
						   <a href="remove-from-cart.jsp?pid=<%=p.getPid()%>"><button class="btn btn-primary px-3">
						   ...
						   %>
						         ...
						         <%
						             boolean flag=WishlistDao.checkwishlist(u.getUid(),p.getPid());
						               ...
						               {
						         %>
						    <a href="add-to-wishlist.jsp?pid=<%=p.getPid()%>"><button class="btn btn-primary px-3">
						    ...
						    <%
						               ...
						               {
						      %>
						      <a href="remove-from-wishlist.jsp?pid=<%=p.getPid()%>"><button class="btn btn-primary px-3">
